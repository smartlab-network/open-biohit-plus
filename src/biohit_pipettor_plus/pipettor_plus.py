...
dll_path: str = "/Users/advaitlath/PycharmProjects/open-biohit-plus/src/biohit_pipettor/include/instrumentLib.dll"
...
from biohit_pipettor.deck_ import Deck
from biohit_pipettor.labware_ import Labware
