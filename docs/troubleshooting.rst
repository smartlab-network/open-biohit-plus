...
workflow failure will be shown and the reason for the error as well. Common errors include
when interacting with following labware type
...
- **PipetteHolder ( IndividualPipetteHolder)** - Pipettor fail to pick tip from selected holder during pick_tip/ replace_tip.
