...
# Create deck
deck1 = Deck((0, 265), (0, 244), range_z=175, deck_id="deck")

# Add slots
slot1 = Slot((0, 118.25), (0, 36.75), 175, "slot1")
slot2 = Slot((128, 246.25), (0, 36.75), 175, "slot2")
slot3 = Slot((0, 118.25), (46, 125.75), 175, "slot3")
slot4 = Slot((128, 246.25), (46, 125.75), 175, "slot4")
slot5 = Slot((0, 118.25), (135, 214.75), 175, "slot5")
slot6 = Slot((128, 246.25), (135, 214.75), 175, "slot6")
deck1.add_slots([slot1, slot2, slot3, slot4, slot5, slot6])

plate_stack = Stack( 113.4, 65, 45,
                       offset=(12.2, 1),can_be_stacked_upon=True, labware_id="platestack1")
...
res_stack = Stack(   size_x=115.5,size_y=79,size_z=30, offset=(4, 0),can_be_stacked_upon=True, labware_id="resstack1")
...
deck1.add_labware(reservoirHolder, slot_id="slot5", min_z=30, x_spacing=17.25)
...
pip_stack = Stack( size_x=102, size_y=65, size_z=59,
    offset=(12.85, 6.1), can_be_stacked_upon=True, labware_id="pip_stack1")
deck1.add_labware(pip_stack, slot_id="slot3", min_z=0  )
deck1.add_labware(pipette_holder, slot_id="slot3", min_z=59, x_spacing=9, y_spacing=9)
